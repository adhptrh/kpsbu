...
class Shift extends CI_Controller
{
    ...
    {
        $data = [
            'pegawai' => $this->db->query("SELECT * FROM pegawai a LEFT JOIN jadwal_shift b ON a.nip = b.id_pegawai WHERE (b.tgl_awal IS NULL OR b.tgl_awal < '".date("Y-m")."' AND b.tgl_akhir < '".date("Y-m")."') AND a.tmt < '".date("Y-m-d")."'")->result(),//$this->master->cek_pegawai()->result(),
