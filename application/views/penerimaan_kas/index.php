                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="datatable">
                        ...
                        foreach ($list as $key => $value) { ?>
                            <tr>
                                <td><?= $no++?></td>
                                <td><?= $value->id_penerimaan?></td>
                                <td><?= $value->tanggal?></td>
                                <td><?= $value->sumber?></td>
                                <td><?= $value->jenis_penerimaan?></td>
                                ...
                                <td class="text-center">
                                    <?php if ($value->jenis_pembayaran == 'Tunai') { ?>
                                        <button class="btn btn-default"><i class="fa fa-check"></i> Selesai</button>
                                    <?php } else { ?>
                                        <?php if (!is_null($value->bukti_trf)) { ?>
                                        <!-- <button data-target="#detail" data-id="<?= $value->id?>" data-img="<?= $value->bukti_trf?>" data-toggle="modal" class="btn btn-default btn-detail"><i class="fa fa-camera"></i> Detail</button> -->
                                        ...
                                        <?php } else { ?> 
                                        <button data-target="#upload" data-id="<?= $value->id?>" data-toggle="modal" class="btn btn-default upload"><i class="fa fa-cloud-upload"></i> Upload</button>
                                        <?php } ?>
                                    <?php } ?>
                                </td>
                            </tr>
...
<?php $this->load->view('penerimaan_kas/add'); ?>
<?php $this->load->view('penerimaan_kas/upload'); ?>
<?php $this->load->view('penerimaan_kas/detail'); ?>
<script>
