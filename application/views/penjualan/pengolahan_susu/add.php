<div class="row">
    <div class="col-sm-6">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form action="<?= base_url('penjualan/detail_pnj_susu_olahan')?>" method="post">
                    ...
                    <hr>
                    <a class="btn btn-default btn-md" href="<?= base_url('penjualan/pengolahan_susu')?>">Kembali</a>
                ...
                <!-- <div class="table-responsive"> -->
                    ...
                    <?php if (count($detail) > 0) { ?>
                        <form action="<?= base_url('Penjualan/save_pnj')?>" method="post">
                            ...
                            <input type="hidden" value="susu_olahan" name="jenis">
