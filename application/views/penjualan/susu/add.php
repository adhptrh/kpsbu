<div class="row">
    <div class="col-sm-6">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form action="<?= base_url('penjualan/detail_pnj_susu')?>" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select name="prod_susu" id="prod_susu" class="form-control">
                                <option value="">-</option>
                    ...
                    <div class="form-group row">
                        <label for="jumlah_lt" class="col-sm-2 col-form-label">Jumlah Liter</label>
                        <div class="col-sm-10">
                            <input type="number" name="jumlah_lt" class="form-control" id="jumlah_lt" placeholder="Jumlah Liter" min="1" value="1">
                        </div>
                    </div>
                    <hr>
                    <a class="btn btn-default btn-md" href="<?= base_url('penjualan/susu')?>">Kembali</a>
                ...
                <!-- <div class="table-responsive"> -->
                    ...
                    <?php if (count($detail) > 0) { ?>
                        <form action="<?= base_url('Penjualan/save_pnj')?>" method="post">
                            ...
                            <input type="hidden" value="susu_murni" name="jenis">

                            <div class="form-group row">
                                <label for="pelanggan" class="col-sm-2 col-form-label">Nama Pembeli</label>
                                <div class="col-sm-6">
                                    <input type="text" name="pelanggan" class="form-control" id="pelanggan" placeholder="Nama Pembeli">
                                </div>
                            </div>
                            <hr>
