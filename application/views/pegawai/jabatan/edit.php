    ...
    aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('c_masterdata/edit_jabatan')?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="t_jabatan" class="form-control" id="t_jabatan" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="<?= $item->tunjangan_jabatan ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="t_kesehatan" class="col-sm-3 col-form-label">Tunjangan Kesehatan</label>
                        <div class="col-sm-9">
                            <input type="text" name="t_kesehatan" class="form-control" id="t_kesehatan" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="<?= $item->tunjangan_kesehatan ?>">
                        </div>
                    </div>
                </div>
